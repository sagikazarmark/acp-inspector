...
| Audio and embedded-context prompt input | Deferred. Image input ([#11](https://github.com/sagikazarmark/acp-inspector/issues/11), [#12](https://github.com/sagikazarmark/acp-inspector/issues/12)) accepts up to eight signature-identified PNG/JPEG/GIF/WebP files through the picker or composer drop: 5 MiB each, 6 MiB aggregate, original bytes, preview/removal, images alone or after text. Its Affordance is gated on `promptCapabilities.image`; its row records the driven outcome. Audio and embeddedContext still have no Affordance. | [#96](https://github.com/sagikazarmark/dioxus-chat.orig/issues/96), [#11](https://github.com/sagikazarmark/acp-inspector/issues/11), [#12](https://github.com/sagikazarmark/acp-inspector/issues/12) |
